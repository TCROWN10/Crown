                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                        ...
                        <span className="text-white font-mono text-lg">{totalRevenue} HBAR</span>
                      </div>
                      <div className="flex justify-between items-center p-3 bg-slate-700/30 rounded-lg">
                        <span className="text-slate-300">Platform Fee (2.5%):</span>
                        <span className="text-red-400 font-mono">-{platformFee} HBAR</span>
                      </div>
                      <div className="flex justify-between items-center p-4 bg-gradient-to-r from-yellow-900/30 to-green-900/30 rounded-lg border border-yellow-500/30">
                        ...
                        <span className="text-yellow-400 font-bold font-mono text-xl">{yourEarnings} HBAR</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
