...
export default function EventDetailPage() {
  ...
  const handleBuyTicket = async () => {
    ...
    try {
      ...
      // Convert price from HBAR to Wei for the contract call
      const priceInWei = parseEther(events.price)
      
      toast.info(`💰 Purchasing ticket for "${events.eventName}" - Please confirm the transaction in your wallet. Ticket price: ${events.price} HBAR`)
