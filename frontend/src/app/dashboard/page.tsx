...
export default function Dashboard() {
  ...
  const stats = useMemo(() => [
    ...
    {
      label: "Total Spent",
      value: `${Number(userStats.totalSpent).toFixed(2)} HBAR`,
    ...
    },
    {
      ...
      value: `${userStats.totalRevenue} HBAR`,
      change: userStats.createdEvents > 0 ? 
  ...
  const recentActivity = useMemo(() => {
    ...
    return tickets
      ...
      .map((ticket: any) => ({
        ...
        amount: `${formatEther(ticket.price)} HBAR`,
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <Card className="bg-gradient-to-br from-slate-800/80 to-orange-900/30 border-orange-500/30">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-slate-300 text-sm">Platform Revenue (HBAR)</p>
                  </CardContent>
                </Card>
              </div>
            </div>
