      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="bg-[#1d1d1d]">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">Step-by-step video guides for using Crown</p>
          ...
          <Card className="bg-[#1d1d1d]">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">In-depth articles about Web3, NFT ticketing, and Hedera development</p>
              <Link href="https://docs.hedera.com/hedera" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="sm" className="w-full bg-[#dd7e9a] hover:bg-[#c06b8a] text-white border-0">
                  Read Hedera Docs <ExternalLink className="ml-2 h-4 w-4" />
                </Button>
              </Link>
            </CardContent>
          </Card>
            ...
            <Card className="bg-[#1d1d1d]">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Our support team is here to help you with any questions about Crown
                </p>
